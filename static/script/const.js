...
const guestPaidButtonPress =
  ...
  <li>Не забудьте поставить галочку "не занимает место"</li>\
...
<li>Если это "Мегафудс" - то тариф Рабочий/Партнер (койко-место) или  Рабочий/Партнер (номер стандарт)</li>\
<li>Если это другой аутсорс - то тариф HOUSEAS</li>\
<li>Укажите дату заезда и выезда</li>\
<li>Если это "Мегафудс " - не забудьте проставить договор (в зависимости от объекта Сигма Б или Хостел С)</li>\
...
<li>Укажите актуальный блок</li>\
<li>Проставьте актуальную категорию номера</li>\
<li>Укажите тип гостя - "Сотрудник партнера"</li>\
<li>Присвойте номер</li>\
